...
var InfoCitiesCSV_1 = require("./CSV/InfoCitiesCSV");
var InfoCitiesAPI_1 = require("./API/InfoCitiesAPI");
function funcionooooo(RutaCSV_or_URL) {
    // El endsWith es un método de los string no una función global de node :b.
    if (RutaCSV_or_URL.endsWith('.csv')) {
        return new InfoCitiesCSV_1.InfoCitiesCSV();
    }
    else {
        return new InfoCitiesAPI_1.InfoCitiesAPI();
    }
}
